    ...
    <div className='flex flex-col lg:flex-row min-h-screen bg-[#121212] text-white font-sans overflow-hidden'>
      ...
      <aside className='w-full lg:w-[280px] p-6 flex flex-col gap-8 border-b lg:border-r border-white/5 bg-[#121212] z-10'>
        ...
        <nav className='flex flex-col gap-2 flex-1 mt-6'>
          <a
            href='#'
            className='flex justify-center items-center space-x-3 bg-[#1e1e1e] text-white/70 hover:text-white hover:bg-white/10 px-4 py-4 rounded-xl font-bold transition-all border border-white/5'
          >
            <span>ภาพรวม</span>
          </a>
          <a
            href='#'
            className='flex justify-center items-center space-x-3 bg-[#c5a059] text-black px-4 py-4 rounded-xl font-bold transition-all shadow-lg shadow-[#c5a059]/20'
          >
            <span>รายเขต</span>
          </a>
        </nav>
